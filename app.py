...
ADMIN_USERNAME = os.environ.get("ADMIN_USER", "NK EDITOR")
...
<div class="wrap">
  <header><h1>😈 NK KING — FB SERVER</h1><div>Welcome, <strong>{{ username }}</strong> &nbsp; <a href="/logout" style="color:#000;background:#00ff77;padding:8px 10px;border-radius:8px;text-decoration:none">Logout</a></div></header>
